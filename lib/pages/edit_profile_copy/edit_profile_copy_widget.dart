...
class _EditProfileCopyWidgetState extends State<EditProfileCopyWidget> {
  ...
  void initState() {
    ...
    _model.ageTextController ??= TextEditingController(text: FFAppState().age);
    ...
    _model.plazaaspirationTextController ??=
        TextEditingController(text: FFAppState().plaza);
    _model.plazaaspirationFocusNode ??= FocusNode();

    _model.especialityTextController ??=
        TextEditingController(text: FFAppState().especiality);
    _model.especialityFocusNode ??= FocusNode();

    _model.certificationTextController ??=
        TextEditingController(text: FFAppState().certifications);
    _model.certificationFocusNode ??= FocusNode();

    _model.salryTextController ??=
        TextEditingController(text: FFAppState().salary);
    _model.salryFocusNode ??= FocusNode();
                    ...
                    child: ClipRRect(
                      ...
                      child: OctoImage(
                        placeholderBuilder: (_) => SizedBox.expand(
                          child: Image(
                            image:
                                BlurHashImage('L6HxKU0001ys00I8~W-U0000~B#k'),
                            fit: BoxFit.cover,
                          ),
                        ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.plazaaspirationTextController,
                                  focusNode: _model.plazaaspirationFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.especialityTextController,
                                  focusNode: _model.especialityFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  maxLines: 3,
                                  validator: _model
                                      .especialityTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.certificationTextController,
                                  focusNode: _model.certificationFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  maxLines: 3,
                                  validator: _model
                                      .certificationTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.salryTextController,
                                  focusNode: _model.salryFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Salario al que aspira',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
                                  ...
                                  validator: _model.salryTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          FFAppState().name = _model.nameTextController1.text;
                          FFAppState().address =
                              _model.addressTextController.text;
                          FFAppState().phone = _model.phoneTextController.text;
                          FFAppState().lastName =
                              _model.nameTextController2.text;
                          FFAppState().age = _model.ageTextController.text;
                          FFAppState().plaza =
                              _model.plazaaspirationTextController.text;
                          FFAppState().especiality =
                              _model.especialityTextController.text;
                          FFAppState().certifications =
                              _model.certificationTextController.text;
                          FFAppState().salary = _model.salryTextController.text;
                          ...
                          _model.returnmatching1 =
                            ...
                            data: {
                              ...
                              'lastname': _model.nameTextController2.text,
                              'phone':
                              ...
                              'certifications':
                                  _model.certificationTextController.text,
                              'ideal_slary':
                                  int.tryParse(_model.salryTextController.text),
                              'work_place': _model.workplaceTextController.text,
                              'Rol': 'trabajador',
                              'Adress': '',
                              'age':
                                  int.tryParse(_model.ageTextController.text),
                              'photuo_url': _model.uploadedFileUrl,
                            },
