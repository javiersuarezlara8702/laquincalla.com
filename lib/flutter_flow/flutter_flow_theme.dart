...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF000055);
  late Color secondary = const Color(0xFFFE2E17);
  late Color tertiary = const Color(0xFFFFB04B);
  late Color alternate = const Color(0xFF2C2E32);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF6F6F6F);
  late Color primaryBackground = const Color(0xFFF8F8F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFD8B5);
  late Color accent2 = const Color(0xFFC7E5BD);
  late Color accent3 = const Color(0xFFFFDF95);
  late Color accent4 = const Color(0xFFFFB88E);
